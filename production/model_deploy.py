...
parser.add_argument("--deploy_name", type=str, required=True, help='name to deploy a model')
...
output = ml_client.online_endpoints.invoke(
    endpoint_name=online_endpoint_name,
    deployment_name=args.deploy_name,
    request_file="./deploy/sample-request.json",
)

logs = ml_client.online_deployments.get_logs(
    name=args.deploy_name, endpoint_name=online_endpoint_name, lines=50
)
